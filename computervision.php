...
<!DOCTYPE html>
    ...
    <head>
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			...
			<li class="nav-item">
				<a class="nav-link" href="index.php#02">Kembali</a>
			</li>
		</div>
		</nav>
		<main role="main" class="container">
    		<div class="starter-template"> <br><br><br>
				...
				<p class="lead">Berikut merupakan hasil analisis gambar yang <b>Anda</b> Upload <br> Karakteristik Gambar ada pada kolom Response.</p>
